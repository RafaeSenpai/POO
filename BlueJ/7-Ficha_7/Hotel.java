...
public abstract class Hotel implements Comparable<Hotel> {
    ...
    */
     ...
     * @return 
     */
    // Depende do tipo concreto do hotel
    /**
    ...
    */
    public abstract double getPrecoNoite();
    ...
    public boolean equals(Object obj) {
        ...
        return o.getCodigo().equals(this.codigo) && o.getNome().equals(this.nome) && 
                ...
                && o.getEstrelas() == this.estrelas && o.getEpoca() == this.getEpoca();
    }
    ...
    public String toString() {
        ...
        sb.append("Encontra-se em epoca alta: " + this.getEpoca());
        return sb.toString();
    }
