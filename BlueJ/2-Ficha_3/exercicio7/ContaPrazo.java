...
public class ContaPrazo
{
    ...
    public ContaPrazo(int cod, String nome,/* int dia, int mes, int ano,*/ double quantia,int dd, int mm, int aa, double tx){
        this.codigo = cod;
        this.titular = nome;
        /*
    ...
    public ContaPrazo(ContaPrazo conta){
        ...
        this.dataCapitalizacao = getPrzCapit();
        this.taxa = getTaxa();
    }
    ...
    public boolean equals(Object o){
        ...
        if (o == null || o instanceof ContaPrazo){
            ...
            return (this.getCodigo() == conta.getCodigo() &&
    ...
    public String toString(){
        ...
        sb.append("Codigo de conta: " + this.getCodigo());
